...
# added score component into the base
# with correct feedbacks when answer is wrong/correct
# the check answer function is developed in this component
# also merged the highest score system in this base
from tkinter import *
import random
